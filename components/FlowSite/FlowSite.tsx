...
import styles from "./FlowSite.module.css";
...
export default function FlowSite() {
  ...
  useEffect(() => {
    ...
    if (marqueeRef1.current) {
      const marqueeTextEl = marqueeRef1.current.querySelector(".marquee-text") as HTMLElement;
      if (marqueeTextEl) {
        gsap.fromTo(
          marqueeTextEl,
          { clipPath: "inset(0 100% 0 0)" },
          {
            ...
            scrollTrigger: { trigger: marqueeTextEl, start: "top 90%", end: "top 40%", scrub: true },
          },
        );
      }
    }
    ...
    <>
      ...
      <div ref={scrollContainerRef} className={styles.scrollContainer}>
        ...
        <div className={styles.contentOverlay}>
          ...
          {/* Marquee 2 */}
          <Marquee ref={marquee2Ref} variant="scroll">
            {marquee2Content}
          </Marquee>
