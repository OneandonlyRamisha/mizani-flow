...
const Science = forwardRef<HTMLDivElement, ScienceProps>(function Science({ lang }, ref) {
  ...
  return (
    <div ref={ref} className={styles.section}>
      <SectionHeader
        label={t("scienceLabel", lang)}
        title={t("scienceTitle", lang)}
        description={t("scienceDesc", lang)}
        className={`science-header ${styles.header}`}
        titleClassName={`science-section-heading ${styles.title}`}
        descClassName={`science-desc ${styles.desc}`}
      />
